...
const BypassMusicPage = {
  ...
  renderHeader() {
    return `
      <div class="bypass-header" style="margin-bottom: var(--space-6); display: flex; justify-content: space-between; align-items: flex-start; gap: 20px;">
        <div>
        ...
        <button class="btn btn-ghost btn-sm" onclick="window.showToolGuide('bypass-music')" style="border-radius: 8px; margin-top: 12px; font-weight: bold; flex-shrink: 0; display: inline-flex; align-items: center; gap: 6px; white-space: nowrap;">
          💻 Panduan & Tips
        </button>
      </div>
    `;
